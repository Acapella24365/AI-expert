...
def get_essay_details():
    ...
    topic = input("What is teh topic of your essay").strip()
...
def generate_essay_content(details):
    ...
    print("\nWould you like the body written as a full draft step_by_step?")
    print("1) Full draft\n2) Step-by-step")
    choice= input("> ").strip()
    ...
    concl_p = f"Write a conclusion for an {details['essay_type']} essay about {details['topic']} with teh stance of {details['target_audience']}."
...
def feedback_and_refinement():
    ...
    if rating != 5:
        ...
        print(f"\nThankyou for your feedback: {feedback}")
    else:
        print("\nThankyou! The essay looks good,")
