...
def generate_image_from_text(prompt):
    ...
    for model in MODELS:
        ...
        for _ in range(3):
            ...
            if r.status_code == 503 and "application/json" in ct:
                ...
                if r.status_code == 200 and "applications/json" not in ct:
                    try:
    ...
    def main():
        ...
        print("This program generates as image from text and applies post-processing effects.")
        ...
        while True:
            ...
            try:
                ...
                if save_option == 'yes':
                    file_name = input("Enter a name forthe image file (without extension):").strip()
