...
Story:"""
    ...
    print(f"Response: {generate_response(few_shot, temperature=0.7, max_tokens=1024)}")

    print("\n--- REFLECTION QUESTIONS ---")
    print("1. How did the responses differ between zero-shot, one-shot and few-shots?")
    print("2.Which approach gave you the most helpful respose?")
